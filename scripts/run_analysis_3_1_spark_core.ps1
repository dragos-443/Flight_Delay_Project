...
function Save-TimingRow {
    ...
    $containerTimingPath = "/tmp/analysis_3_1_spark_core_timings.csv"
...
foreach ($currentRunSize in $runSizes) {
    ...
    Write-Host "Eseguo analisi 3.1 Spark Core ($currentRunSize)"
    ...
    $sparkOutput = Invoke-DockerChecked @(
        ...
        "/opt/project/src/analysis_3_1_spark_core.py",
